...
echo "/bin/bash ambarinode_setup.sh https://github.com/DataAnalyticsOrganization/AmbariKave-azure/archive/master.zip KaveAdmin KavePassword01 'localhost ambari gate ci nno-0 nno-1 data-0 data-1 data-2' 2.0-Beta https://raw.githubusercontent.com/DataAnalyticsOrganization/AmbariKave-azure/master/Automation/kave_blueprint/KAVEAzure.blueprint.json https://raw.githubusercontent.com/DataAnalyticsOrganization/AmbariKave-azure/master/Automation/kave_blueprint/KAVEAzure.cluster.json"
